...
<head>
    <title> 500 Something went horribly wrong :(</title>
...
<div class="h-screen w-screen flex flex-wrap justify-center content-end md:content-center items-end md:items-center relative z-10">
    <div class="p-6 text-center ">
        ...
        <p class="mt-3 uppercase text-sm lg:text-base text-gray-900">If you are the application owner check the logs for more information.</p>
...
<!--
    500 Tracking in Plausible inspired by 404 tracking below
    https://plausible.io/docs/404-error-pages-tracking
-->

<script>plausible("500",{ props: { path: document.location.pathname } });</script>
