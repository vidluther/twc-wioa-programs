 ...
 <div class="px-3 py-3 w-full overflow-hidden rounded-lg shadow-xs">
        <div class="w-full overflow-x-auto">
            <table class="w-full whitespace-no-wrap px-2 py-2">
                <thead>
                <tr
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-2 py-3"> {{ ucwords($program->provider_campus_city) }} </td>
                    <td class="px-2 py-3"> {{ ucwords($program->provider_campus_county) }} </td>
