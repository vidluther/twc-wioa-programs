<x-slot name="header">
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
          <span class="space-y-4"> This website is a list of eligible training programs for the
             <strong>Texas Workforce Commission WIOA program. </strong> <br />
         </span>
        @include('statcards')
...
Inclusion on the statewide ETPL does not guarantee that a Board will refer any student to the program or that it will receive any funds.
        ...
        services and training services, must give priority to recipients of public assistance, other low-income individuals,
        and individuals who are basic skills deficient. Under WIOA, priority must be implemented regardless of the amount of
        funds available to provide services in the local area. In addition, veterans receive priority of service in all
        DOL-funded employment programs.
        </span>
        <h2 class="font-semibold py-2">Ummm... What?</h2>
        <span class="prose space-y-4">
       Basically, there's a federal program that helps people learn a new skill or trade. It's designed to
            help people in need, meaning if you're low-income, or are on welfare, and qualify, the government will pay
            for a class that will teach you a new skill, which may help you get a better job.<br />

            You need to work with your local Workforce Commission office to make sure you qualify
            and for them to pay the right people.
        </span>


        <h2 class="font-semibold py-2">I still don't understand.. how does this site help me?</h2>
        <span class="prose space-y-4">
       This website gives you the ability to search for programs that are approved by the Texas Workforce Commission.
            It tells you how much the class will cost, where it's at and who to contact to sign up for the class.
        </span>
        <h2 class="font-semibold py-2">What do I do after I sign up?</h2>
        <span class="prose space-y-4">
            Once
            you've signed up for the class, you need to contact your local TWC office, let them know you've signed up
    ...
    <p>
        <ul>
            <li> Proof of income.. or lack thereof.</li>
            <li> Past 26 weeks of paystubs (if you have any)</li>
            <li> Proof of Address </li>
            <li> You'll have to prove who's living with you/your dependents </li>
        </ul>
    </p> <br />
