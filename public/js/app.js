...
__webpack_require__(/*! ./plausible */ "./resources/js/plausible.js");
...
var elements = document.querySelectorAll("a[data-analytics]");
registerAnalyticsEvents(elements, handleLinkEvent); // Handle button form events - those that have data-analytics
...
function handleLinkEvent(event) {
  ...
  if (middle || click) registerEvent(link.getAttribute('data-analytics')); // Delay navigation so that Plausible is notified of the click
...
function registerEvent(data) {
  // break into array
  var attributes = data.split(/,(.+)/); // Parse it to object
